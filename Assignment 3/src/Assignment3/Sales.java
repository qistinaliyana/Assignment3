	...
	public Sales() {
	    ...
	    AddButton.addActionListener(new ActionListener() {
	    	public void actionPerformed(ActionEvent e) {
				...
				try {
					Customer r = new Customer(s, s1, s2); //open customer page using constructor with 5 arguments
					r.setVisible(true);
				} catch (Exception ee) {
					ee.printStackTrace();
				}
		...
		UploadButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					File file = new File ("C:\\Users\\HP\\eclipse-workspace\\Assignment 3\\src\\Assignment3\\sales.txt");
					if(!file.exists()) {
						file.createNewFile();
						}
